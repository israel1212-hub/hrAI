      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-57px)] px-4 py-12">
        <div className="w-full max-w-[420px]">
          <div className="text-center mb-7">
            <h1 className="text-[#0F172A] text-3xl font-extrabold mb-2 font-syne">Create your account</h1>
            ...
            <UrlProvider>
              <form className="flex flex-col gap-4">
                <div className="space-y-1.5">
                  <Label htmlFor="full_name" className="text-[#0F172A] text-sm font-semibold">Full Name</Label>
                  <Input id="full_name" name="full_name" type="text" placeholder="Alex Johnson" required
                ...
                <div className="space-y-1.5">
                  ...
                  <Input id="password" type="password" name="password" placeholder="Min. 6 characters" minLength={6} required
                    className="w-full rounded-xl border-[#E2E8F0] bg-[#F8FAFC] text-[#0F172A] focus:border-[#2563EB] focus:ring-[#2563EB]/10" />
                </div>
