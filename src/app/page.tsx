            ...
            <div className="flex flex-col justify-center">
              ...
              <div>
                ...
                <div className="flex items-end gap-8 flex-wrap">
                  ...
                  <svg height="20" viewBox="0 0 60 25" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-30">
                  ...
                  <span className="text-[#B8C8DC] text-[10px] font-light tracking-widest uppercase">Stripe</span>
                  </div>

                  {/* Vercel */}
                  <div className="flex flex-col items-center gap-2">
                  <svg height="16" viewBox="0 0 283 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-30">
                  ...
                  <span className="text-[#B8C8DC] text-[10px] font-light tracking-widest uppercase">Vercel</span>
                  </div>

                  {/* Notion */}
                  <div className="flex flex-col items-center gap-2">
                  <svg height="18" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-30">
                  ...
                  <span className="text-[#B8C8DC] text-[10px] font-light tracking-widest uppercase">Notion</span>
                  </div>

                  {/* Figma */}
                  <div className="flex flex-col items-center gap-2">
                  <svg height="20" viewBox="0 0 38 57" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-30">
                  ...
                  <span className="text-[#B8C8DC] text-[10px] font-light tracking-widest uppercase">Figma</span>
                  </div>
                  ...
                  <span className="text-[#B8C8DC] text-[10px] font-light tracking-widest uppercase">Linear</span>
                  </div>
