      ...
      <div className="bg-white rounded-2xl p-8 shadow-xl max-w-md w-full text-center">
        ...
        {status === "failed" && (
          <>
            ...
            <p className="text-[#64748B] text-sm mb-6">{message}</p>
            <Link href="/wallet" className="inline-flex items-center gap-2 px-6 py-3 bg-[#7C3AED] text-white rounded-xl font-semibold text-sm hover:bg-[#6D28D9] transition-colors">
              Back to Wallet
            </Link>
          </>
        )}
