    ...
    <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-[#E8EDF5]">
      <div className="max-w-[1100px] mx-auto px-6 py-3.5 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="text-[#0F172A] font-bold text-base font-syne">HireMind AI</span>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-7">
          ...
          {/* Always show Sign In & Sign Up in center nav */}
          {!user && (
            <>
              <Link href="/sign-in" className="text-[#475569] hover:text-[#0F172A] text-sm font-medium transition-colors">Sign In</Link>
              <Link href="/sign-up" className="text-[#475569] hover:text-[#0F172A] text-sm font-medium transition-colors">Sign Up</Link>
            </>
          )}
        </div>
        ...
        <div className="flex items-center gap-3">
          {user ? (
            ...
            <>
              <Link href="/sign-in" className="text-[#475569] hover:text-[#0F172A] text-sm font-medium transition-colors md:hidden">
                Sign In
              </Link>
